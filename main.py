...
table_input = "INSERT INTO tracker (vehicle, date, mileage, litres, cost, currency) VALUES ('{VEHICLE}', '{TODAY}', '{MILEAGE}', '{LITRES}', '{COST}', '{CURRENCY}')"
...
cursor.execute(table_input.format(VEHICLE = vehicle_output, TODAY = today, MILEAGE = mileage_output, LITRES = litres_output, COST = cost_output, CURRENCY = currency_output))
